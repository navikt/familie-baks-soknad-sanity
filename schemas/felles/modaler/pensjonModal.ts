...
const pensjonModal = [
  localeblock(Steg.FELLES, DokumentNavn.MODAL_PENSJONSPERIODE_TITTEL_SOKER),
  localeblock(Steg.FELLES, DokumentNavn.MODAL_PENSJONSPERIODE_TITTEL_ANDRE_FORELDER),
  localeblock(Steg.FELLES, DokumentNavn.MODAL_PENSJONSPERIODE_TITTEL_OMSORGSPERSON),
